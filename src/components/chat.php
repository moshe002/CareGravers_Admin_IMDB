    ...
    <div>
        ...
        <div class="container mx-auto" style="margin-top: -128px;">
            <div class="py-6 h-screen">
                <div style="height:84%; width:98%;" class="flex border border-grey rounded shadow-lg h-full">
                    ...
                    <div class="w-2/3 border flex flex-col">
                        ...
                        <div class="bg-grey-lighter px-4 py-4 flex items-center">
                            ...
                            <div class="flex-1 mx-4">
                                <input id="chat-input" class="w-full border rounded px-2 py-2" type="text"/>
                            </div>
                            <div>
                            ...
                            <audio id="swooshSound">
                                <source src="../assets/audio/sent.mp3" type="audio/mpeg">
                            </audio>    
                        </div>
                    </div>
